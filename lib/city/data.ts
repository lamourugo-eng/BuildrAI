...
export const CITY_LEVELS: CityLevel[] = [
  {
    ...
    name: 'Débutant',
    minXp: 0,
    tagline: 'Un petit bureau, un terrain vide. Vous posez la première pierre.',
    scene: 'seed',
    visualTier: 'beginner',
    accent: '#94a3b8',
  },
  {
    ...
    name: 'En croissance',
    minXp: 80,
    tagline: 'Votre espace s\'agrandit. Les premières structures émergent.',
    scene: 'awakening',
    visualTier: 'beginner',
    accent: '#60a5fa',
  },
  {
    ...
    name: 'Intermédiaire',
    minXp: 200,
    tagline: 'Des bâtiments apparaissent, vos premiers alliés rejoignent l\'aventure.',
    scene: 'growing',
  ...
  },
  {
    ...
    name: 'Avancé',
    minXp: 450,
    tagline: 'Quartier d\'entreprise. Votre écosystème prend forme.',
    scene: 'hub',
    visualTier: 'advanced',
    accent: '#a78bfa',
  },
  {
    ...
    minXp: 750,
    tagline: 'Grands bâtiments, écosystème complet. Vous avez construit votre parcours.',
    scene: 'ecosystem',
    visualTier: 'advanced',
    accent: '#fbbf24',
  },
...
export const CITY_BUILDINGS: CityBuildingDef[] = [
  ...
  },
  {
    id: 'roadmap_tower',
    name: 'Tour du plan',
    description: '25 % de votre parcours jour par jour complété.',
    icon: '🗼',
    slot: { x: 78, y: 42 },
  },
  {
  ...
  },
  {
    id: 'coach_hq',
    name: 'Siège coaching',
    description: '10 messages échangés. Vous avancez avec constance.',
    icon: '🏢',
    slot: { x: 64, y: 48 },
    scale: 1.1,
  },
  {
    ...
    description: '50 % du parcours complété. La moitié du chemin est derrière vous.',
    icon: '🏛️',
    slot: { x: 68, y: 34 },
    scale: 1.15,
  },
  ...
  },
  {
    id: 'innovation_lab',
    name: 'Lab innovation',
    description: '25 messages coach. Vous expérimentez et itérez.',
    icon: '🔬',
    slot: { x: 58, y: 38 },
  },
  {
  ...
  },
  {
    id: 'premium_hq',
    name: 'QG BuildrAI',
    description: 'Abonnement actif. Vous investissez dans votre progression.',
    icon: '◈',
    slot: { x: 28, y: 68 },
  },
  {
    ...
    description: 'Phase avancée du coaching. Votre business se structure.',
    icon: '🌆',
    slot: { x: 50, y: 16 },
    scale: 1.25,
  },
