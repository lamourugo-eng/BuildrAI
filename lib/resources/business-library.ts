      ...
      resources: [
        {
          ...
          howToUse:
            'Parcours la liste en 15 min. Retiens 3 modèles qui te parlent, puis creuse un seul avec la grille d’analyse.',
        ...
        },
        {
          ...
          description: 'Évalue ton idée en 8 critères avant de te lancer.',
          howToUse:
            'Réponds par écrit à chaque ligne. Si le score global est faible, pivote un critère à la fois. N\'abandonne pas sans tester.',
        ...
        },
        {
          ...
          howToUse:
            'Coche honnêtement. Moins de 5/8 ? Retourne sur la grille ou fais 5 conversations clients avant de continuer.',
          timeEstimate: '10 min',
          coachPhase: 1,
          roadmapChapter: 1,
        ...
        },
        {
          ...
          howToUse:
            'Suis un jour à la fois. Note les retours dans ton bloc-notes, puis partage-les au coach le jour 7.',
      ...
      resources: [
        {
          ...
          howToUse:
            'Copie le template, remplis chaque section, publie sur Carrd/Notion/Webflow. Demande au coach de relire ton hero et CTA.',
          timeEstimate: '1–2 h',
          coachPhase: 5,
          roadmapChapter: 1,
          copyable: true,
...
Réserver un appel / Commander / S'inscrire`,
        },
        {
          ...
          howToUse:
            'Personnalise la 2e phrase pour chaque contact. Envoie 5 messages par jour, note les réponses dans le tableau KPI.',
...
10. OK pour un call de 20 min cette semaine ?`,
        },
        {
          ...
          howToUse:
            'Remplis les 3 colonnes. Garde une formule d’entrée accessible et une premium crédible. Valide avec le coach phase 6.',
          timeEstimate: '45 min',
          coachPhase: 6,
          roadmapChapter: 2,
          copyable: true,
...
Canal principal : ${ctx.channel}`,
        },
        {
          ...
          description: 'Limite le périmètre pour lancer en moins de 2 semaines.',
          howToUse:
            'Coche chaque point. Si une case reste vide, réduis le scope avant de coder ou d’acheter des outils.',
          timeEstimate: '20 min',
          coachPhase: 3,
          roadmapChapter: 1,
          items: [
      ...
      resources: [
        {
          ...
          howToUse:
            'Copie dans ChatGPT ou demande au coach « adapte ce prompt à ma niche ». Sélectionne 5 idées, planifie-les sur 2 semaines.',
          timeEstimate: '15 min',
          coachPhase: 7,
          roadmapChapter: 3,
          copyable: true,
...
Contexte niche : ${ctx.nicheExamples[0]}.`,
        },
        {
          ...
          howToUse:
            'Complète niche et zone, lance le prompt, puis vérifie 3 concurrents manuellement sur Google.',
          timeEstimate: '30 min',
          coachPhase: 1,
          roadmapChapter: 1,
          copyable: true,
...
8. Verdict : GO / PIVOT / NO-GO avec justification`,
        },
        {
          ...
          howToUse:
            'Remplis problème et prix visé. Colle le résultat dans le coach pour affiner packages et objections.',
          timeEstimate: '20 min',
          coachPhase: 3,
          roadmapChapter: 1,
          copyable: true,
...
7. Script pitch 60 secondes`,
        },
        {
          ...
          howToUse:
            'Génère le brouillon IA, puis transfère section par section dans le template « page de vente » de l’étape Lancer.',
          timeEstimate: '45 min',
          coachPhase: 5,
          roadmapChapter: 1,
          copyable: true,
...
Ton : professionnel, concret, pas de jargon.`,
        },
        {
          ...
          howToUse:
            'Copie ce texte dans l’onglet Coach IA (Premium). Remplace [RESSOURCE] par ce que tu viens d’utiliser ici.',
          timeEstimate: '5 min',
          coachPhase: 1,
          copyable: true,
...
3. Dis-moi quel jour du parcours 180 jours cocher après`,
        },
        {
          ...
          howToUse:
            'Remplace J12 par ton jour actuel (visible dans Parcours). Colle dans le coach. Ou clique « Discuter » depuis le parcours.',
          timeEstimate: '5 min',
          roadmapChapter: 1,
          copyable: true,
    ...
    },
    {
      ...
      resources: [
        ...
        },
        {
          ...
          howToUse:
            'Choisis 3 piliers, planifie 3 posts/semaine dans un doc. Recycle 1 contenu long en 5 posts courts.',
        ...
        },
        {
          ...
          howToUse:
            'Copie le tableau, mets à jour chaque dimanche. Compare avec ton analyse hebdomadaire si tu es en formule 79 €.',
...
- Canal principal : ${ctx.channel}`,
        },
        {
          ...
          howToUse:
            'Lis les options, note ton statut cible. Formalise seulement quand tu as clients et chiffre d’affaires récurrent.',
          timeEstimate: '30 min',
          coachPhase: 1,
          roadmapChapter: 1,
          items: [
        ...
        },
        {
          ...
          howToUse:
            'Applique dès le 1er client signé. Une checklist par client dans ton bloc-notes.',
        ...
        },
        {
          ...
          howToUse:
            'Coche au fil des mois 4–6. Utile pour scale, levée ou revente. Pas urgent au début.',
